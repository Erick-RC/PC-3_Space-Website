    ...
    <header className="navbar">
      ...
      <ul className="nav-list">
        ...
        <li className="nav-item hover_effect" id="destination">
          <NavLink
            className="nav-link"
            to="/fm-space-tourism-website/destination/Moon"
          >
      ...
      <div id="ham" className="nav-corner show" onClick={handleMenu}>
        <img className="icon-ham" src={iconHam} alt="svg-hamburger" />
      </div>

      <div id="drop" className="dropdown-menu hide">
        ...
        <ul className="nav-list-drop">
          ...
          <li className="nav-item-drop hover_effect" id="crew2">
            <NavLink
              className="nav-link-drop"
              to="/fm-space-tourism-website/crew"
            >
          ...
          <li className="nav-item-drop hover_effect" id="tech2">
            <NavLink
              className="nav-link-drop"
              to="/fm-space-tourism-website/tech"
            >
